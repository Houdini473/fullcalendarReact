...
var FullCalendar = /** @class */ (function (_super) {
  ...
  FullCalendar.prototype.render = function () {
    return React.createElement(
      common.CalendarDataProvider,
      { optionOverrides: this.props, calendarApi: this._calendarApi },
      function (data) {
        return React.createElement(
          common.CalendarRoot,
          {
          ...
          function (classNames, height, isHeightAuto, forPrint) {
            return React.createElement(
              "div",
              { className: classNames.join(" "), style: { height: height } },
              React.createElement(
                common.CalendarContent,
                tslib.__assign(
